...
![venturablocker](https://raw.githubusercontent.com/Theile/venturablocker/main/screenshot.png)

_This project is totally copied from the original bigsurblocker from which I made montereyblocker, and now also venturablocker._

To fully uninstall `venturablocker`, run the script [venturablocker-remove.sh](venturablocker-remove.sh) (as root or with `sudo`) or deploy through MDM.
